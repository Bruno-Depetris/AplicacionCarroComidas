...
namespace AplicacionCarroComidas.Forms.Notificacion {
    public partial class Mensaje : Form {
        ...
        // Rutas de íconos
        string ErrorPath = Path.Combine(Application.StartupPath, "Public/Img", "error.png");
        string OkPath = Path.Combine(Application.StartupPath, "Public/Img", "check.png");
        string CashPath = Path.Combine(Application.StartupPath, "Public/Img", "forex_trade_chart_stock.png");
        string Admin = Path.Combine(Application.StartupPath, "Public/Img", "admin.png");
        string BaseDatos = Path.Combine(Application.StartupPath, "Public/Img", "bd.png");
        string Buscar = Path.Combine(Application.StartupPath, "Public/Img", "buscar.png");
        string Edit = Path.Combine(Application.StartupPath, "Public/Img", "edit.png");
        string Delete = Path.Combine(Application.StartupPath, "Public/Img", "delete.png");
        string Zapatillas = Path.Combine(Application.StartupPath,   "Public/Img", "zapatillas.png");
        ...
        string simple = Path.Combine(Application.StartupPath, "Public/Song", "simple-notification-152054.wav");
        string ui = Path.Combine(Application.StartupPath, "Public/Song", "ui-3-sound-effect-warn-242229.wav");
        string error = Path.Combine(Application.StartupPath, "Public/Song", "error-126627.wav");
